...
var h=a.replace(/\/[^\/]*$/,"").split("/"),f={id:a,exports:{},require:function(a,b){if("string"!==typeof a)return f.require.async.call(null,a[0],b);a=e(a);return a[0].require(a[1]).exports}};f.require.supports=["ucjs2-pinf-0"];f.require.id=function(a){a=e(a);return a[0].require.id(a[1])};f.require.async=function(a,b){a=e(a);a[0].load(a[1],b)};f.require.sandbox=function(){3===arguments.length&&(arguments[2].load=arguments[2].load||d.load);/^\./.test(arguments[0])&&(arguments[0]=n.replace(/\/[^\/]*$/,
